...
// finalized 7/10/26); their tier/turnaround is unknown — set it in the app.
export const defaultSubmissionMeta: Submission[] = [
  ...
  { key: 4, name: 'Sub 4', description: 'Mixed', orderNumber: '14972306', tier: 'Value Bulk', turnaroundDays: 95, shipping: 112.07, status: 'at-psa', dateShipped: '2026-05-28' },
  { key: 5, name: 'Sub 5A', description: 'Chinese Pokemon', shipping: 0, status: 'at-psa', dateShipped: '2026-07-10' },
  { key: 6, name: 'Sub 5B', description: 'Chinese Pokemon', shipping: 0, status: 'at-psa', dateShipped: '2026-07-10' },
